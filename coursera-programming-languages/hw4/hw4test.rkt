...
(define tests
  (test-suite
   ...
   ;(check-equal? (list-nth-mod (list) 2) 2 "list-nth-mod test")
   ;(check-equal? (list-nth-mod (list 0 1 2 3 4) -1) 2 "list-nth-mod test")
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero funny-number-stream) 5) (list (cons 0 1) (cons 0 2) (cons 0 3) (cons 0 4) (cons 0 -5)) "stream-add-zero test")
   ...
   (check-equal? (vector-assoc 4 (vector (cons 2 1) (cons 3 1) "hello" (cons 4 1) (cons 5 1))) (cons 4 1) "vector-assoc test")
   
   ; cached-assoc tests
   (check-equal? ((cached-assoc (list (cons 1 2) (cons 3 4)) 3) 3) (cons 3 4) "cached-assoc test")
   (check-equal? ((cached-assoc (list (cons 1 2) (cons 3 4)) 3) 3) (begin (cons 3 4) (cons 3 4)) "cached-assoc test")
   #|
   ; while-less test
