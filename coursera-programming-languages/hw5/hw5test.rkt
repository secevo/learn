...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (call (fun #f "x" (add (var "x") (int 7))) (int 1))) (int 8) "call test 2")
   ...
   (check-equal? (eval-exp (ifeq (int 3) (int 2) (int 3) (int 4))) (int 4) "ifeq test2")
   (check-equal? (eval-exp (ifeq (int 2) (int 2) (int 3) (int 4))) (int 3) "ifeq test3")

   (check-equal? (eval-exp (call (fun #f "xs" (ifgreater (isaunit (var "xs")) (int 0) (aunit) (int 100))) (aunit))) (aunit) "call test!")
   ;; mupl-map test
